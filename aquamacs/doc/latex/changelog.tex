...
\emph{Interested in trying out the Aquamacs 2.0 series, based on Cocoa and Emacs 23?  As of Late 2009, we're still working \emph{on} it, but we've already got a lot to show!  \url{http://aquamacs.org/nightlies.shtml}}
