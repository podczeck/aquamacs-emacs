...
\subsection{Changes--- 1.8rc1}

{\color{red} Interested in trying out the Emacs 23 Cocoa version of Aquamacs?  We're still working on it, but we're also already working with it. 
