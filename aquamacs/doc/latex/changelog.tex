...
\subsection{Changes--- 1.8b}

{\color{red} Interested in trying out the Emacs 23 Cocoa version of Aquamacs?  As of Spring 2008, we're still working \emph{on} it, but we're also already working \emph{with} it. 
